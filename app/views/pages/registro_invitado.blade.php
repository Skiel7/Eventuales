...
@section('content')
		...
		{{Form::open(array('method'=>'POST','url'=>'/registro_invitado','role'=>'form'))}} 
	...
	<div class="container" > 
    	<div class="col-lg-6">
			<!--{{Form::open()}}-->
					...
					<legend>Registro por invitacion</legend>
					 <input name="idus" type="hidden" value="{{$idInvitado}}">	
					<!--Nombre-->
					...
					<!--Mail-->
                        <div class="form-group">
							{{Form::label('E-mail')}}
							{{Form::text('email', Usuario::find($idInvitado)->email, array('readonly' => 'readonly', 'class' => 'form-control'))}}
